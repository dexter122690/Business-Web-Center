...
(function(){
  ...
  function addCashActions(){
    ...
    var categories='<option>Parts &amp; Materials</option><option>Labor</option><option>Salaries &amp; Wages</option><option>Cost of Sales</option><option>Shipping Expense</option><option>Transportation Allowance</option><option>Supplies Expense</option><option>Marketing Expense</option><option>Utilities Expense</option><option>Other</option>',today=new Date().toISOString().slice(0,10);
