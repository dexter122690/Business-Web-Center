...
(function(){
  var db=null,businessId='',userId='',selectedId='',records=[],showPaid=false;
  ...
  document.addEventListener('click',function(event){
    ...
    if(event.target.id==='togglePaidInvoicePayments'){showPaid=!showPaid;selectedId='';render()}
