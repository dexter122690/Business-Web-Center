...
(function(){
  ...
  function beginOnlineSync(){
    ...
    if(!observerStarted){observerStarted=true;new MutationObserver(function(){replaceLegacyIssueButtons();decorateAttendanceReview()}).observe(document.body,{childList:true,subtree:true});}
  }
